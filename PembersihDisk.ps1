...
#GUI Variables
$FormTitleText = "Pembersih Disk oleh Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Pilih Disk:"
$FreeSpaceLabelText = "Ruang Kosong (gigabyte): "
$TotalSpaceLabelText = "Total Ruang (gigabyte): "
$JunkFoundLabelText = "sampah ditemukan (gigabyte):"
$CleanDiskBtnText = "Bersihkan Disk *Hapus Berkas*"
$SpaceCleanedLabelText = "Ruang yang dibersihkan (gigabyte): "
$LogFileLabelText = "Berkas log ditemukan: $abcdefg"
$CreditLabelText = "Skrip oleh Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Berkas log ditemukan"
$AnalyzingDriveText = "Menganalisis Drive..."
$BrowsersAreRunningText = "Browser sedang berjalan... Beri tahu pengguna..."
$PleaseCloseBrowsersText = "Silakan tutup semua web browser dan coba lagi."
$CleaningDriveText = "Membersihkan Drive..."
...
$DiskSlimmerForm.ClientSize = New-Object System.Drawing.Point(517,335)
...
$DriveComboBox.width = 230
$DriveComboBox.height = 20
$DriveComboBox.location = New-Object System.Drawing.Point(267,16)
...
$FreeSpaceValue.location = New-Object System.Drawing.Point(401,57)
...
$TotalSpaceValue.location = New-Object System.Drawing.Point(401,91)
...
$JunkFoundValue.location = New-Object System.Drawing.Point(401,125)
...
$SpaceCleanedValue.location = New-Object System.Drawing.Point(401,219)
...
$LogFileLabel.text = $AnalyzingDriveText
...
$LogFileLabel.text = "$LogFileLocatedText - $logfile"


$CleanDiskBtn.Add_Click({  

    #Show-Console
    $LogFileLabel.text = $CleaningDriveText
    ...
    if($BrowserCheck -eq $false) {
        ...
        Write-Host $BrowsersAreRunningText
        $LogFileLabel.text = $PleaseCloseBrowsersText
